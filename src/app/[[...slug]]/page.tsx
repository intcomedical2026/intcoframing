...
const routeMetaDefaults: Record<string, Partial<Record<Locale, RouteMeta>>> = {
  ...
  "/projects": {
    en: {
      ...
      image: "https://cdn.sanity.io/images/vzcnnept/production/9b23c10023cc8a909addb8f37416a5b645a3c9d6-1920x600.jpg",
      imageAlt: "Projects",
    },
    es: {
  ...
  "/solutions/business-insights-trends": {
    en: {
      ...
      image: "https://cdn.sanity.io/images/vzcnnept/production/84f1bbba0333ecaa3afd99f0db4148b7baefffef-1920x600.png",
  ...
  "/solutions/business-insights-trends/trend": {
    en: {
      ...
      image: "https://cdn.sanity.io/images/vzcnnept/production/92c4e097b80b075f5e9b5eecb71cc07463820353-690x582.jpg",
  ...
  "/solutions/business-insights-trends/trend-2": {
    en: {
      ...
      description: "Download the INTCO Framing trend report and stay informed about the latest consumer, design, and market trends.",
      image: "https://cdn.sanity.io/images/vzcnnept/production/7122bf537a96658f450d8aa4f056967ea6c2d8b8-690x582.png",
      imageAlt: "INTCO trend report",
    },
    es: {
  ...
  "/solutions/business-insights-trends/trend-2-2": {
    en: {
      ...
      description: "Download the INTCO Framing trend report and stay informed about the latest consumer, design, and market trends.",
      image: "https://cdn.sanity.io/images/vzcnnept/production/77fd52fd1920d88e66321a93c24ddd9bd920b57c-690x582.jpg",
      imageAlt: "INTCO trend report",
    },
    es: {
  ...
  "/solutions/business-insights-trends/bestsellers": {
    en: {
      ...
      image: "https://cdn.sanity.io/images/vzcnnept/production/dff42f59e1e337d978fd8e58ddde7a4e468e62fb-1080x1080.jpg",
  ...
  "/contact": {
    en: {
      ...
      image: "https://cdn.sanity.io/images/vzcnnept/production/845d15b6ca8b13aea633aec140bb453434d77111-1920x600.jpg",
...
function buildStructuredData(
  ...
  if (routeItem?.faqs?.length) {
    nodes.push({
      ...
      datePublished: validIsoDate(routeItem.datePublished),
      dateModified: validIsoDate(routeItem.dateModified),
      mainEntity: routeItem.faqs.map((item, index) => ({
        "@type": "Question",
        name: item.question,
        url: `${currentUrl}#${safeAnchorId(item.anchorId, index)}`,
        acceptedAnswer: {
          "@type": "Answer",
          text: item.answer,
        },
